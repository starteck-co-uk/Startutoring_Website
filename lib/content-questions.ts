...
export const CONTENT_MATHS_11PLUS: Question[] = [
  ...
  { text: 'What is 8,003 − 4,567?', options: ['3,436', '3,536', '3,336', '4,436'], correct: 0, explanation: '8,003 − 4,567 = 3,436.' },
  { text: 'What is 347 × 6?', options: ['2,082', '2,182', '1,982', '2,282'], correct: 0, explanation: '347 × 6 = 2,082.' },
  { text: 'What is 1,764 ÷ 12?', options: ['147', '148', '146', '149'], correct: 0, explanation: '1,764 ÷ 12 = 147.' },
  { text: 'What is 2/5 of 350?', options: ['140', '150', '130', '170'], correct: 0, explanation: '350 ÷ 5 = 70, then 70 × 2 = 140.' },
  { text: 'Convert 0.75 to a fraction in simplest form.', options: ['3/4', '7/10', '15/20', '6/8'], correct: 0, explanation: '0.75 = 75/100 = 3/4 in simplest form.' },
  { text: 'What is 15% of 240?', options: ['36', '24', '30', '48'], correct: 0, explanation: '10% of 240 = 24, 5% = 12, so 15% = 36.' },
  { text: 'A regular hexagon has a perimeter of 42 cm. What is the length of one side?', options: ['7 cm', '6 cm', '8 cm', '5 cm'], correct: 0, explanation: '42 ÷ 6 sides = 7 cm per side.' },
  { text: 'What is the area of a triangle with base 10 cm and height 6 cm?', options: ['30 cm²', '60 cm²', '16 cm²', '36 cm²'], correct: 0, explanation: 'Area = ½ × base × height = ½ × 10 × 6 = 30 cm².' },
  { text: 'A cuboid is 5 cm × 4 cm × 3 cm. What is its volume?', options: ['60 cm³', '50 cm³', '12 cm³', '24 cm³'], correct: 0, explanation: 'Volume = 5 × 4 × 3 = 60 cm³.' },
  { text: 'What is the next number in the sequence: 3, 7, 15, 31, ?', options: ['63', '47', '55', '62'], correct: 0, explanation: 'Each number is doubled then +1: 3×2+1=7, 7×2+1=15, 15×2+1=31, 31×2+1=63.' },
  { text: 'Simplify: 4/6 + 1/3', options: ['1', '5/6', '7/9', '2/3'], correct: 0, explanation: '4/6 = 2/3, then 2/3 + 1/3 = 3/3 = 1.' },
  { text: 'What is the mean of 12, 15, 18, 21, and 24?', options: ['18', '15', '20', '19'], correct: 0, explanation: 'Sum = 90, count = 5, mean = 90 ÷ 5 = 18.' },
  { text: 'A clock shows 3:45 PM. What angle do the hands make?', options: ['157.5°', '172.5°', '150°', '180°'], correct: 0, explanation: 'At 3:45, minute hand at 270° and hour hand at 112.5°, giving 157.5°.' },
  { text: 'If a = 4 and b = 7, what is 3a + 2b?', options: ['26', '24', '22', '28'], correct: 0, explanation: '3(4) + 2(7) = 12 + 14 = 26.' },
  { text: 'What is the perimeter of a semicircle with diameter 14 cm? (π ≈ 22/7)', options: ['36 cm', '22 cm', '44 cm', '50 cm'], correct: 0, explanation: 'Perimeter = πd/2 + d = 22 + 14 = 36 cm.' },
  { text: 'A bag has 3 red, 5 blue and 2 green balls. What is the probability of picking a blue ball?', options: ['1/2', '1/3', '3/10', '2/5'], correct: 0, explanation: 'Total = 10, blue = 5, probability = 5/10 = 1/2.' },
  { text: 'Convert 2.5 hours into minutes.', options: ['150 minutes', '125 minutes', '160 minutes', '145 minutes'], correct: 0, explanation: '2.5 × 60 = 150 minutes.' },
  { text: 'A rectangle has length 15 cm and width 8 cm. What is its perimeter?', options: ['46 cm', '23 cm', '120 cm', '38 cm'], correct: 0, explanation: 'Perimeter = 2(15 + 8) = 2 × 23 = 46 cm.' },
  { text: 'Round 4,567 to the nearest hundred.', options: ['4,600', '4,500', '4,570', '5,000'], correct: 0, explanation: '4,567 rounds up to 4,600 (67 ≥ 50).' },
  { text: 'What are the factors of 36?', options: ['1,2,3,4,6,9,12,18,36', '1,2,3,6,12,36', '1,2,4,6,9,36', '1,3,6,9,18,36'], correct: 0, explanation: '36 has factors: 1, 2, 3, 4, 6, 9, 12, 18, 36.' },
  { text: 'A pie chart shows 90° for Science. What fraction of students chose Science?', options: ['1/4', '1/3', '1/2', '1/5'], correct: 0, explanation: '90° out of 360° = 90/360 = 1/4.' },
  { text: 'What is the lowest common multiple (LCM) of 6 and 8?', options: ['24', '48', '12', '16'], correct: 0, explanation: 'Multiples of 6: 6,12,18,24. Multiples of 8: 8,16,24. LCM = 24.' },
  { text: 'What is 4³?', options: ['64', '12', '16', '48'], correct: 0, explanation: '4³ = 4 × 4 × 4 = 64.' },
  { text: 'A shop offers 20% off a £45 jacket. What is the sale price?', options: ['£36', '£38', '£40', '£35'], correct: 0, explanation: '20% of £45 = £9, sale price = £45 − £9 = £36.' },
  { text: 'If 5x − 3 = 22, what is x?', options: ['5', '4', '3', '6'], correct: 0, explanation: '5x = 25, x = 5.' },
  { text: 'How many millilitres are in 3.5 litres?', options: ['3,500 ml', '350 ml', '35,000 ml', '3,050 ml'], correct: 0, explanation: '3.5 × 1,000 = 3,500 ml.' },
  { text: 'What is the highest common factor (HCF) of 24 and 36?', options: ['12', '6', '8', '4'], correct: 0, explanation: 'Factors of 24: 1,2,3,4,6,8,12,24. Factors of 36: 1,2,3,4,6,9,12,18,36. HCF = 12.' },
];
